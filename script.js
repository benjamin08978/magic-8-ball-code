...
l   Hint: you should not be declaring anything new besides the variables from Step 1a.
  */
let milk = 'no way'
let jack = 'of course not'
let atticus = 'absoultely' 
let chase = 'of course' 
  magic8Ball.listOfAnswers = [milk, jack, atticus, chase,];
  ...
  /* 
    ...
    2c. Whoaaaa... why did that happen?
        Answer: the higher the number is the slower it will be to fade in 
  ...
  */
    ...
    */
    ...
    var answer = this.listOfAnswers[0];
